                ...
                <div class=" col-md-12 col-sm-12 col-12 col-lg-12 col-xl-12  bg-gray rounded py-3"
                    ...
                    <form action="{{ '' }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group ">
                                    <label for="category_name">Select Your Service Category</label>
                                    <select name="category_name" id="" class="form-control form-select">

                                        <option disabled value="{{ old('category_name') }}" selected>Select Category
                                        </option>
