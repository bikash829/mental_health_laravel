<div>
    <div class="row justify-content-center">
        <div class="col-md-3 col-lg-3 align-self-center">
            ...
            <h3 class="text-muted text-center pt-2">{{$user?->expert?->doc_title}} {{$user?->first_name . ' ' .$user?->last_name }}</h3>
                    ...
                    <div class="accordion-body">
                        <div class="row g-2">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <label class="text-muted">{{$data->from_date}} - {{$data?->to_date}}  @if ($data?->job_status)
                                        {{__('Present')}}
                                        @endif
                                    </label>
                                    {{-- <span>{{$data->from_date}}</span> --}}
