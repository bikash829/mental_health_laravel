...
@section('content')
    <div class="container px-4">
        <div class="row ">
            ...
            @endif
            <h2 class="text-center text-danger pb-5">Manage Services</h2>
                        ...
                        <tbody>
                            @foreach ($scheduleData as $data)
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->status == 1)
                                            <a href="{{ route('doctor.schedule.status', $data->id) }}"
                        ...
                        <tbody>
                            @foreach ($patientData as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('doctor.patient_appointment.view', $data->id) }}"
