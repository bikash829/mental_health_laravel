    ...
    <header class="header">
        ...
        <nav class="nav nav--font nav--padding">
            ...
            <div class="nav__logo-container">
                <a href="{{route('home')}}"><img data-href="{% url 'home' %}" class="nav__logo" id="nav__logo" src="{{asset('images/logo/logo_.png') }} " alt="Logo"></a>
            </div>

            <!-- navigation menu bar  -->
            <ul class="nav__menu">
                <li class="nav__item"><a class="nav__link {{ $home ?? '' }}" href="{{route('home')}}">Home</a></li>
                <li class="nav__item nav__dropdown--item"><a class="nav__link {{$doctor_counselor ?? ''}}" href="{{route('doctor_counselor')}}">Services <i class="fa-solid fa-caret-down"></i></a>

                    <ul class="nav__dropdown">
                        <li class="nav__item"><a class="nav__link {{$doctor_counselor ?? ''}}" href="{{route('doctor_counselor')}}">Doctor & Counselor</a></li>
                ...
                <li class="nav__item"><a class="nav__link {{$community ?? ''}}" href="{{route('community')}}">Community Forum</a></li>
                <li class="nav__item"><a class="nav__link {{$about ?? ''}}" href="{{route('about')}}">About</a></li>
                <li class="nav__item"><a class="nav__link {{$contact ?? ''}}" href="{{route('contact')}}">Contact</a></li>
            </ul>
