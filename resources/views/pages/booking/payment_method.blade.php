...
@section('banner')
    <div class="banner ">
        <h1 class="banner__title">Payment Method</h1>
        ...
        <section class="segment-margin">
            <div class="container">
                ...
                <div class="row ">
                    ...
                    <div class=" col-md-6 col-sm-12 col-12 offset-md-3  bg-gray rounded py-3 "
                        style="border: 1px solid #ddd">
                        <h5 class="text-center text-gray ">Total Fee : &#2547;{{ $data->fee }}</h5>

                        <form action="{{ route('booking.service.confirmingOrderForPayment', $data->id) }}" method="POST">
                            @csrf
