    ...
    <section class="segment-margin">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class=" col-md-8 col-sm-12 col-12 offset-md-3  bg-gray rounded py-3" style="border: 1px solid #ddd">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 pb-3">
                                <div class="form-group ">
                                    ...
                                    <input type="phone" class="form-control" value="{{old('phone',Auth::user()->phone)  }}"
                            ...
                            <div class="col-md-6 col-12 pb-3">
                                <div class="form-group ">
                                    @php
                                        $age = Auth::user()->date_of_birth ? now()->diffInYears(Auth::user()->date_of_birth) : old('age');
                                    @endphp
                            ...
                            <div class="col-md-6 col-12 pb-3">
                                @php
                                    $address = Auth::user()?->address?->address . ', ' . Auth::user()?->address?->city . '-' . Auth::user()?->address?->zip_code ?? old('address');
                                @endphp
                                <div class="form-group ">
                                    <label for="address">Address</label>
                                    <input type="text" class="form-control" value="{{old('address',$address)  }}"
                                        name="address" id="specialist" placeholder="Enter your speciality ">
                                    @error('address')
                                        <p class="text-danger ">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12 col-12 pb-3">
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('patient_problem') }}"
                                        name="patient_problem" id="patient_problem" placeholder="Enter patient problem ">
