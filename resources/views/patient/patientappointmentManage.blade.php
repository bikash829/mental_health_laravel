                        ...
                        <table id="dataTable" class="table responsive table-bordered dataTable" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($patientData as $data)
                                        ...
                                        <td>
                                            @if ($data->status == 1)
                                                <span class="bg-success p-1 "
                                                    style="text-decoration: none; pointer-events: none; ">Active</span>
                                            @else
                                                <span href="" class="bg-warning p-1"
                                                    style="text-decoration: none; pointer-events: none;">Inactive</span>
                                            @endif
                                        </td>
                                        <td>
                                    ...
                                    <div class="modal fade" id="appointmentRating_{{ $data->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Appointment Rating (10/?)
                                                    </h5>
                                                    ...
                                                    <div class="modal-body ">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                placeholder="Enter Your Appointment Rating ">
